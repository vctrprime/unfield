...
namespace Unfield.Repositories.Migrations
{
    ...
    [Migration("20230302201231_AddRatesEntities1")]
    partial class AddRatesEntities1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.Rates.Price", b =>
                {
                    ...
                    b.Property<int>("RateDayIntervalId")
                        .HasColumnType("integer")
                        .HasColumnName("rate_day_interval_id");
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.Rates.Rate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("rate", "rates");
                });

            modelBuilder.Entity("Unfield.Domain.Entities.Rates.RateDayInterval", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("rate_day_interval", "rates");
                });
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.Rates.Price", b =>
                {
                    ...
                    b.HasOne("Unfield.Domain.Entities.Rates.RateDayInterval", "RateDayInterval")
                        .WithMany("Prices")
                        .HasForeignKey("RateDayIntervalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.Rates.RateDayInterval", b =>
                {
                    b.HasOne("Unfield.Domain.Entities.Rates.DayInterval", "DayInterval")
                        .WithMany("RateDayIntervals")
                        .HasForeignKey("DayIntervalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Unfield.Domain.Entities.Rates.Rate", "Rate")
                        .WithMany("RateDayIntervals")
                    ...
                    b.HasOne("Unfield.Domain.Entities.Accounts.User", "UserCreated")
                        .WithMany("CreatedRateDayIntervals")
                        .HasForeignKey("UserCreatedId");

                    b.HasOne("Unfield.Domain.Entities.Accounts.User", "UserModified")
                        .WithMany("LastModifiedRateDayIntervals")
                        .HasForeignKey("UserModifiedId");
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.Accounts.User", b =>
                {
                    ...
                    b.Navigation("CreatedRateDayIntervals");
                    ...
                    b.Navigation("LastModifiedRateDayIntervals");

                    b.Navigation("LastModifiedRates");
