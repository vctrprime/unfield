...
namespace Unfield.Repositories.Migrations
{
    ...
    [Migration("20230423143159_AddBookings1")]
    partial class AddBookings1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.BookingForm.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.BookingForm.BookingCost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.BookingForm.BookingCustomer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.BookingForm.BookingInventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.Settings.StadiumMainSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("stadium_main_settings", "settings");
                });
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.BookingForm.BookingCost", b =>
                {
                    b.HasOne("Unfield.Domain.Entities.BookingForm.Booking", "Booking")
                        .WithMany("Costs")
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.BookingForm.BookingCustomer", b =>
                {
                    b.HasOne("Unfield.Domain.Entities.BookingForm.Booking", "Booking")
                        .WithOne("Customer")
                        .HasForeignKey("Unfield.Domain.Entities.BookingForm.BookingCustomer", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.BookingForm.BookingInventory", b =>
                {
                    ...
                    b.HasOne("Unfield.Domain.Entities.Accounts.User", "UserCreated")
                        .WithMany("CreatedBookingsInventories")
                        .HasForeignKey("UserCreatedId");

                    b.HasOne("Unfield.Domain.Entities.Accounts.User", "UserModified")
                        .WithMany("LastModifiedBookingsInventories")
                        .HasForeignKey("UserModifiedId");
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.Settings.StadiumMainSettings", b =>
                {
                    b.HasOne("Unfield.Domain.Entities.Accounts.Stadium", "Stadium")
                        ...
                        .HasForeignKey("Unfield.Domain.Entities.Settings.StadiumMainSettings", "StadiumId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Unfield.Domain.Entities.Accounts.User", "UserModified")
                        .WithMany("LastModifiedStadiumMainSettings")
                        .HasForeignKey("UserModifiedId");
            ...
            modelBuilder.Entity("Unfield.Domain.Entities.Accounts.User", b =>
                {
                    ...
                    b.Navigation("CreatedBookingsInventories");
                    ...
                    b.Navigation("LastModifiedBookingsInventories");
                    ...
                    b.Navigation("LastModifiedStadiumMainSettings");
