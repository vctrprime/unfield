...
using Unfield.Common.Hubs;
using Unfield.Extranet.Infrastructure;
using Unfield.Extranet.Infrastructure.Extensions;
using Unfield.Extranet.Infrastructure.Middleware;

namespace Unfield.Extranet;
...
public class Startup
{
    ...
    public void Configure( IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger )
    {
        ...
        if ( env.IsDevelopment() )
        {
            ...
            app.UseSwaggerUI( c => { c.SwaggerEndpoint( "/swagger/v1/swagger.json", "Unfield Extranet API" ); } );
        }
