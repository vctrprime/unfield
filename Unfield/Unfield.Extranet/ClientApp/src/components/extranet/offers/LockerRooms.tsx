...
export const LockerRooms = () => {
    ...
    const onNameClick = (id: number) => {
        navigate("/offers/locker-rooms/" + id);
    }
    ...
    const columnDefs = [
        ...
        },
        {
            field: 'userCreated',
            cellClass: "grid-center-cell",
            headerName: t("offers:locker_rooms_grid:user_created"),
            width: 200
        },
        {
            field: 'dateCreated',
            cellClass: "grid-center-cell",
            headerName: t("offers:locker_rooms_grid:date_created"),
            width: 170,
    ...
    return (<div className="locker-rooms-container">
        <div className="locker-rooms-btns">
            <Button
                ...
                onClick={() => navigate("/offers/locker-rooms/new")}>{t('offers:locker_rooms_grid:add')}</Button>
