...
using Unfield.BookingForm.Infrastructure;
using Unfield.BookingForm.Infrastructure.Extensions;
using Unfield.BookingForm.Infrastructure.Middleware;
...
public class Startup
{
            ...
            services.AddSwaggerGen(
                c =>
                {
                    ...
                    c.SwaggerDoc(
                        ...
                        new OpenApiInfo
                        {
                            Title = "Unfield Booking Form API",
                            Version = "v1"
                        } );
    ...
    public void Configure( IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger )
    {
        ...
        if ( env.IsDevelopment() )
        {
            ...
            app.UseSwaggerUI( c => { c.SwaggerEndpoint( "/swagger/v1/swagger.json", "Unfield Booking Form API" ); } );
        }
