...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StadiumEngine.Domain.Entities.Rates.Rate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StadiumEngine.Domain.Entities.Rates.RateDayInterval", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StadiumEngine.Domain.Entities.Rates.Price", b =>
                {
                    ...
                    b.HasOne("StadiumEngine.Domain.Entities.Rates.RateDayInterval", "RateDayInterval")
                        .WithMany("Prices")
            ...
            modelBuilder.Entity("StadiumEngine.Domain.Entities.Rates.RateDayInterval", b =>
                {
                    ...
                    b.HasOne("StadiumEngine.Domain.Entities.Rates.Rate", "Rate")
                        .WithMany("RateDayIntervals")
