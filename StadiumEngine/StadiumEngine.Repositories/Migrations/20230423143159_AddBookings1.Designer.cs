...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StadiumEngine.Domain.Entities.Accounts.RoleStadium", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StadiumEngine.Domain.Entities.BookingForm.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StadiumEngine.Domain.Entities.BookingForm.BookingCost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StadiumEngine.Domain.Entities.BookingForm.BookingCustomer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StadiumEngine.Domain.Entities.BookingForm.BookingInventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StadiumEngine.Domain.Entities.Settings.StadiumMainSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StadiumEngine.Domain.Entities.BookingForm.BookingCost", b =>
                {
                    b.HasOne("StadiumEngine.Domain.Entities.BookingForm.Booking", "Booking")
                        .WithMany("Costs")
            ...
            modelBuilder.Entity("StadiumEngine.Domain.Entities.BookingForm.BookingCustomer", b =>
                {
                    b.HasOne("StadiumEngine.Domain.Entities.BookingForm.Booking", "Booking")
                        .WithOne("Customer")
                        .HasForeignKey("StadiumEngine.Domain.Entities.BookingForm.BookingCustomer", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("StadiumEngine.Domain.Entities.Settings.StadiumMainSettings", b =>
                {
                    b.HasOne("StadiumEngine.Domain.Entities.Accounts.Stadium", "Stadium")
                        ...
                        .HasForeignKey("StadiumEngine.Domain.Entities.Settings.StadiumMainSettings", "StadiumId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
