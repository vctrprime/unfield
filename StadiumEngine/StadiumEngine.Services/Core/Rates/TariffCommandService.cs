...
internal class TariffCommandService : ITariffCommandService
{
    private readonly ITariffRepositoryFacade _tariffRepositoryFacade;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ITariffValidator _validator;

    public TariffCommandService( ITariffRepositoryFacade tariffRepositoryFacade, IUnitOfWork unitOfWork, ITariffValidator validator )
    {
