...
using StadiumEngine.CustomerAccount.Infrastructure;
using StadiumEngine.CustomerAccount.Infrastructure.Extensions;
using StadiumEngine.CustomerAccount.Infrastructure.Middleware;

namespace StadiumEngine.CustomerAccount;
...
public class Startup
{
            ...
            services.AddSwaggerGen(
                c =>
                {
                    ...
                    c.SwaggerDoc(
                        ...
                        new OpenApiInfo
                        {
                            Title = "Stadium Engine Customer Account API",
                            Version = "v1"
                        } );
    ...
    public void Configure( IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger )
    {
        ...
        if ( env.IsDevelopment() )
        {
            ...
            app.UseSwaggerUI( c => { c.SwaggerEndpoint( "/swagger/v1/swagger.json", "Stadium Engine Customer Account API" ); } );
        }
