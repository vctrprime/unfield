...
export const PriceGroups = () => {
    ...
    const columnDefs = [
        ...
        {field: 'fieldNames', headerName: t("rates:price_groups_grid:fields"), width: 600, cellRenderer: FieldNamesRenderer },
        {field: 'description', headerName: t("rates:price_groups_grid:description"), width: 500, cellRenderer: (obj: any) => <GridCellWithTitleRenderer value={obj.data.description}/> },
        {field: 'userCreated', cellClass: "grid-center-cell", headerName: t("rates:price_groups_grid:user_created"), width: 200},
        {field: 'dateCreated', cellClass: "grid-center-cell", headerName: t("rates:price_groups_grid:date_created"), width: 170, valueFormatter: dateFormatter},
    ];
